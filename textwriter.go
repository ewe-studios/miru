...
import (
	...
	"github.com/influx6/pkg/miru/parse"
)
...
const (
	...
	helperAlias        = "helpers"
	helperImportPath   = "github.com/influx6/pkg/helpers"
...
func (t *TextWriter) ParseTree() error {
	t.addImport("peji", "github.com/influx6/pkg/peji")
	t.addImport("styled", "github.com/influx6/pkg/styled")
